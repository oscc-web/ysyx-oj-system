...
layui.config({
    base: '/ecepims/ecep_frameworks/easyweb/module/croppers/' //layui自定义layui组件目录
}).define(['jquery','layer','cropper'],function (exports) {
    var $ = layui.jquery
        ,layer = layui.layer;
    var html = "<link rel=\"stylesheet\" href=\"/ecepims/ecep_frameworks/easyweb/module/croppers/cropper.css\">\n" +
